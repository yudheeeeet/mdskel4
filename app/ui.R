        ...
        tabItem(
          ...
          fluidRow(
            box(title = div("What is Sigmaria?", style = "font-weight: bold; text-align: center;"),
                ...
                collapsible = TRUE,
                collapsed = TRUE,
                img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/depan1.png", width = "100%", style = "margin-bottom: 20px;"),
            ...
            box(title = div("How to use this Platform?", style = "font-weight: bold; text-align: center;"),
                ...
                collapsible = TRUE,
                collapsed = TRUE,
                img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/depan2.png", width = "100%", style = "margin-bottom: 20px;"),
            ...
            box(
              ...
              fluidRow(
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/16.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/17.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/18.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/19.png", width = "100%", style = "margin: 0; padding: 0;"),
                  tags$a(href = "https://www.amazon.com/Trendy-Queen-Oversized-Sweatshirts-Turtleneck/dp/B0C5RFPCWK/ref=sr_1_2?crid=HF4HA55C8V0G&dib=eyJ2IjoiMSJ9.ra5EbfipI6ZsHNWNipsBARsPfCQi5-B-_sG5ciia0xM3Rt9WITWLzam2OIPTn_nPiuaH9a37P-0YAuZ48DvTzI4KRHeoUrfJN4o9v7BwkcW91xkqJUuXrkR32XFKRlA7pDTdtHqiNCj5BG749IrUmDjlfEpYAeNVPniD8RCb9DIAVenKP1TtMg47ZppMPWih5kUHPyanfvRob9zlzZJxbcP-3nqhxyIGD92QwbQg_tc.da8Tl2V6c5e2cPeFy8lJBQ_Rja6QRFUtDasMflfCtRw&dib_tag=se&keywords=Trendy+Queen+Womens+Oversized+Sweatshirts+Turtleneck+Pullover+Long+Sleeve+Hoodies+Tops+Fall+Outfits+2023+Clothes&qid=1710244600&sprefix=dokotoo+tops+for+women+trendy+summer+casual+cap+short+sleeve+basic+textured+solid+color+round+neck+t+shirts+blouse%2Caps%2C448&sr=8-2",
                         class = "btn btn-block", role = "button", "BUY", style = "font-weight:bold; background-color:#4876FF; color: #FFFFFF;"),
                  style = "border-radius: 10px; background-color: #FFFFFF; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);"
                ),
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/20.png", width = "100%", style = "margin: 0; padding: 0;"),
            ...
            box(
              ...
              fluidRow(
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/11.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/12.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/13.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/14.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/15.png", width = "100%", style = "margin: 0; padding: 0;"),
            ...
            box(
              ...
              fluidRow(
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/1.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/2.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/3.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/4.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/6.png", width = "100%", style = "margin: 0; padding: 0;"),
            ...
            box(
              ...
              fluidRow(
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/5.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/7.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/8.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/9.png", width = "100%", style = "margin: 0; padding: 0;"),
                ...
                box(
                  ...
                  background = "white",
                  width = 4,
                  img(src = "https://github.com/yudheeeeet/mdskel4/raw/main/Image/10.png", width = "100%", style = "margin: 0; padding: 0;"),
